...
<ul id="product_list" class="clear news_list">
	{if $all_news|@count > 0}
	...
	<li class=" clearfix">
		...
		<a href="{$modules_dir}prestanews/details-news.php?id={$news.id_news}" class="button lnk_view btn btn-default" >
		<span>{l s='Read more' mod='prestanews'}</span></a>
	</li>
	{/foreach}
	{else}
